...
void distanceCalc(double *fx,double *fy,double *r,double *A,double *q, double *pf, mwSize n)
{
  double rij[2];
  double dr;
  double fmag;
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    */
    ...
    distanceCalc(fx,fy, position,adjacency,charge,k,(mwSize)nrows);
}
